...
export default function PerfilPage() {
    ...
    const validateFields = () => {
        ...
        if (!telefoneRegex.test(telefone)) return "Telefone inválido. Formato esperado: (00) 00000-0000.";
        if (endereço.trim().length < 5) return "O endereço deve ter pelo menos 5 caracteres.";
        if (usuario.trim().length < 4) return "O nome de usuário deve ter pelo menos 4 caracteres.";
